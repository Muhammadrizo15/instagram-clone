            ...
            <div className="popupdetailfwpruhwe" onClick={() => { setShow(false) }} style={show ? null : { display: 'none' }}>
                <div className="modfdfsdafasal-content" style={{ zIndex: 9879789789789 }}>
                    <div className="modal-content model-content-fooo popup__post">
                        <div className="closepopupicon" onClick={() => { setShow(false) }}>
                            <svg aria-label="Закрыть" class="closepopup" color="#ffffff" fill="#ffffff" height="18" role="img" viewBox="0 0 24 24" width="18"><title>Закрыть</title><polyline fill="none" points="20.643 3.357 12 12 3.353 20.647" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3"></polyline><line fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="3" x1="20.649" x2="3.354" y1="20.649" y2="3.354"></line></svg>
                        </div>
                            ...
                            <div className="post__likes__and__saves__wrap">
                                <div className="post__likes__and__saves">
                                    <div className="post__like__com__send">
                                        ...
                                        <div className="icon__with__padding">
                                            <svg aria-label="Комментировать" class="_ab6-" color="#fafafa" fill="#fafafa" height="24" role="img" viewBox="0 0 24 24" width="24"><path d="M20.656 17.008a9.993 9.993 0 1 0-3.59 3.615L22 22Z" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></path></svg>
                                        </div>
                                        <div className="icon__with__padding">
                                            <svg aria-label="Поделиться публикацией" class="_ab6-" color="#fafafa" fill="#fafafa" height="24" role="img" viewBox="0 0 24 24" width="24"><line fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="2" x1="22" x2="9.218" y1="3" y2="10.083"></line><polygon fill="none" points="11.698 20.334 22 3.001 2 3.001 9.218 10.084 11.698 20.334" stroke="currentColor" stroke-linejoin="round" stroke-width="2"></polygon></svg>
                                        </div>
                                    </div>
                                    <div className="icon__with__padding">
                                        <svg aria-label="Сохранить" class="_ab6-" color="#fafafa" fill="#fafafa" height="24" role="img" viewBox="0 0 24 24" width="24"><polygon fill="none" points="20 21 12 13.44 4 21 4 3 20 3 20 21" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></polygon></svg>
                                    </div>
                                </div>
